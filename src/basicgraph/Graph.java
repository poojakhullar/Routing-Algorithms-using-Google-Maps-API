...
//	
//	//returns the index specified by the vertex
	public int getIndex(Integer v1){
		return  vertices.indexOf(v1);
	}
//	
	public int getDegree(int v){
		System.out.println(getNeighbors(v).size());
	...
	public List<Integer> degreeSequence() {
		...
		for (int v=0; v>numVertices; v++){
			one.add(getInNeighbors(v).size() + getNeighbors(v).size());
	...
	public static void main (String[] args) {
		...
		GraphLoader.loadRoadMap("data/maps/UCSD_Testgraph.map", graphFromFile);
		...
		System.out.println("****");
		System.out.println(airportGraph.getDistance2(v));
		
		GraphAdjMatrix matrix = new GraphAdjMatrix();
		//System.out.println(matrix.getDistance2(v));
