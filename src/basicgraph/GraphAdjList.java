...
public class GraphAdjList extends Graph {
	 ...
	 */		
	 public List<Integer> getDistance2(int v) {
		 ...
		 for (int u : getNeighbors(v)){         // get neighbors of v in u
			 twohop.addAll(getNeighbors(u));    // add the neighbors of u to list
		 }
	...
	public static void main (String[] args) {
		GraphAdjList airportGraph1 = new GraphAdjList();
		int v = 2;
		System.out.println(airportGraph1.getDistance2(v));
	}
